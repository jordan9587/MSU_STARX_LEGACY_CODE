...
void loop()
{
  ...
  float map_bar_pressure = map(analog_val, 0, 4095, 0, 1000);    // 0v (zero bars) to 10v (100 bars). Alternatively, you could maintain 1 decimal place of accuracy in bar if you keep with int values.
  ...
  float psi_Pressure =  map_bar_pressure * 14.503773773;    // Conversion between bar and psi
  ...
  Serial.println(map_bar_pressure);     
