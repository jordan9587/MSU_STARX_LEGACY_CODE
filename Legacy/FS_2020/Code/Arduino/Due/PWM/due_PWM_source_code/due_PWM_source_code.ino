...
//#############################################################################################################################################
  ...
  REG_PMC_PCER1 |= PMC_PCER1_PID36;                     // Enable PWM using peripheral clock controller. Only need to do this once.
  REG_PWM_CLK = PWM_CLK_PREA(0110) | PWM_CLK_DIVA(1);      // Setting the clock rate to 84Mhz. Only do this once. 
...
// Control the duty cycle on digital pin 9 with pot signal
